...
tec_render_layout_start(
    ...
    [
        ['label' => 'Volver al portal', 'url' => tec_portal_url(), 'class' => 'light'],
        ['label' => 'Ver evaluaciones', 'url' => tec_listado_url(), 'class' => 'light'],
    ]
);
?>
<div class="split">
    ...
    <aside class="stack">
        ...
        <section class="card">
            ...
            <div class="toolbar">
                <a class="btn outline" href="<?= tec_h(tec_portal_url()) ?>">Portal principal</a>
                <a class="btn outline" href="<?= tec_h(tec_listado_url()) ?>">Histórico de evaluaciones</a>
            </div>
        </section>
    </aside>
</div>
