...
function tec_v(mixed $value, string $default = '0'): string
{
    if ($value === null || $value === '') {
        return $default;
    }
...
function tec_f(mixed $value, int $decimals = 2): string
{
    return number_format((float)$value, $decimals, ',', '.');
}

function tec_json_pretty(array $data): string
{
...
<section class="card stack">
    <div class="meta-top">
        <div>
            <h1 style="margin:0 0 6px;">Evaluación #<?= tec_h((string)$id) ?></h1>
            <p class="muted" style="margin:0;">
                Candidato: <strong><?= tec_h((string)($evaluacion['nombre_candidato'] ?? 'Sin nombre')) ?></strong>
                · Área: <strong><?= tec_h((string)($evaluacion['area'] ?? 'Técnicas')) ?></strong>
                · Categoría: <strong><?= tec_h((string)($evaluacion['categoria'] ?? 'PCD/PUP')) ?></strong>
            </p>
        </div>

        <div class="resultado-badge <?= $esPositiva ? 'positiva' : 'negativa' ?>">
            <?= $esPositiva ? '✅' : '❌' ?> <?= tec_h($resultadoTexto) ?>
        </div>
    </div>
</section>
    ...
    <div class="stack">
        <section class="card stack">
            ...
            <table class="tabla-puntuaciones">
                ...
                <tbody>
                    <tr><td><strong>1.A</strong> Publicaciones científicas y patentes</td><td><?= tec_f($evaluacion['puntuacion_1a'] ?? 0) ?></td><td>32</td></tr>
                    <tr><td><strong>1.B</strong> Libros y capítulos de libro</td><td><?= tec_f($evaluacion['puntuacion_1b'] ?? 0) ?></td><td>3</td></tr>
                    <tr><td><strong>1.C</strong> Proyectos y contratos de investigación</td><td><?= tec_f($evaluacion['puntuacion_1c'] ?? 0) ?></td><td>12</td></tr>
                    <tr><td><strong>1.D</strong> Transferencia de tecnología</td><td><?= tec_f($evaluacion['puntuacion_1d'] ?? 0) ?></td><td>6</td></tr>
                    <tr><td><strong>1.E</strong> Dirección de tesis doctorales</td><td><?= tec_f($evaluacion['puntuacion_1e'] ?? 0) ?></td><td>4</td></tr>
                    <tr><td><strong>1.F</strong> Congresos, conferencias y seminarios</td><td><?= tec_f($evaluacion['puntuacion_1f'] ?? 0) ?></td><td>2</td></tr>
                    <tr><td><strong>1.G</strong> Otros méritos de investigación</td><td><?= tec_f($evaluacion['puntuacion_1g'] ?? 0) ?></td><td>1</td></tr>

                    <tr><td colspan="3" style="background: rgba(255, 255, 255, 0.05);"><strong>Bloque 2 · Experiencia docente</strong></td></tr>

                    <tr><td><strong>2.A</strong> Docencia universitaria</td><td><?= tec_f($evaluacion['puntuacion_2a'] ?? 0) ?></td><td>17</td></tr>
                    <tr><td><strong>2.B</strong> Evaluaciones sobre su calidad</td><td><?= tec_f($evaluacion['puntuacion_2b'] ?? 0) ?></td><td>3</td></tr>
                    <tr><td><strong>2.C</strong> Cursos y seminarios de formación docente universitaria</td><td><?= tec_f($evaluacion['puntuacion_2c'] ?? 0) ?></td><td>3</td></tr>
                    <tr><td><strong>2.D</strong> Material docente, proyectos y contribuciones al EEES</td><td><?= tec_f($evaluacion['puntuacion_2d'] ?? 0) ?></td><td>7</td></tr>
                    ...
                    <tr><td><strong>3.A</strong> Tesis, becas, estancias, otros títulos</td><td><?= tec_f($evaluacion['puntuacion_3a'] ?? 0) ?></td><td>6</td></tr>
                    <tr><td><strong>3.B</strong> Trabajo en empresas / instituciones / hospitales</td><td><?= tec_f($evaluacion['puntuacion_3b'] ?? 0) ?></td><td>2</td></tr>

                    <tr><td colspan="3" style="background: rgba(255, 255, 255, 0.05);"><strong>Bloque 4</strong></td></tr>

                    <tr><td><strong>4</strong> Otros méritos</td><td><?= tec_f($evaluacion['puntuacion_4'] ?? 0) ?></td><td>2</td></tr>
                </tbody>
            </table>
        </section>
        ...
        <?php if (!empty($diagnostico)): ?>
            <section class="card stack">
                ...
                <?php if (!empty($diagnostico['perfil_detectado'])): ?>
                    <p><strong>Perfil detectado:</strong> <?= tec_h((string)$diagnostico['perfil_detectado']) ?></p>
                <?php endif; ?>
                    ...
                    <div>
                        ...
                        <ul class="lista-simple">
                            <?php foreach ($diagnostico['reglas'] as $regla): ?>
                                <li>
                                    <?= tec_h((string)($regla['nombre'] ?? 'Regla')) ?>:
                                    actual <?= tec_f($regla['valor_actual'] ?? 0) ?> /
                                    objetivo <?= tec_f($regla['objetivo'] ?? 0) ?>
                                    <?php if (isset($regla['deficit'])): ?>
                                        · déficit <?= tec_f($regla['deficit']) ?>
                                    <?php endif; ?>
                                </li>
                            <?php endforeach; ?>
                        </ul>
        ...
        <?php if (!empty($asesor)): ?>
            <section class="card stack">
                ...
                <?php if (!empty($asesor['resumen'])): ?>
                    <p><?= tec_h((string)$asesor['resumen']) ?></p>
                <?php endif; ?>
                    ...
                    <div class="acciones-asesor">
                        <?php foreach ($asesor['acciones'] as $accion): ?>
                            <div class="accion-item">
                                <div><strong><?= tec_h((string)($accion['titulo'] ?? 'Acción')) ?></strong></div>
                                <?php if (!empty($accion['detalle'])): ?>
                                    <div style="margin-top:6px;"><?= tec_h((string)$accion['detalle']) ?></div>
                                <?php endif; ?>
                                <?php if (!empty($accion['impacto_estimado'])): ?>
                                    <div class="maximo" style="margin-top:8px;">
                                        Impacto estimado: <?= tec_h((string)$accion['impacto_estimado']) ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; ?>
                    ...
                    <div>
                        ...
                        <div class="sim-grid" style="margin-top:10px;">
                            <?php foreach ($asesor['simulaciones'] as $sim): ?>
                                <div class="sim-item">
                                    <div><strong><?= tec_h((string)($sim['escenario'] ?? 'Escenario')) ?></strong></div>
                                    <?php if (!empty($sim['efecto_estimado'])): ?>
                                        <div style="margin-top:6px;"><?= tec_h((string)$sim['efecto_estimado']) ?></div>
                                    <?php endif; ?>
                                    <?php if (isset($sim['nuevo_b1_b2_aprox'])): ?>
                                        <div class="maximo" style="margin-top:8px;">
                                            Nuevo 1+2 aprox.: <?= tec_f($sim['nuevo_b1_b2_aprox']) ?>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (isset($sim['nuevo_total_aprox'])): ?>
                                        <div class="maximo">
                                            Nuevo total aprox.: <?= tec_f($sim['nuevo_total_aprox']) ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
        ...
        <section class="card stack">
            <details>
                ...
                <pre><?= tec_h(tec_json_pretty($jsonEntrada)) ?></pre>
            </details>
        </section>
    </div>
        ...
        <section class="card">
            ...
            <div class="kpis">
                <div class="kpi">
                    ...
                    <strong><?= tec_f($evaluacion['puntuacion_1a'] ?? 0) ?></strong>
                </div>
                <div class="kpi">
                    <span class="label">1C</span>
                    <strong><?= tec_f($evaluacion['puntuacion_1c'] ?? 0) ?></strong>
                </div>
                <div class="kpi">
                    <span class="label">1D</span>
                    <strong><?= tec_f($evaluacion['puntuacion_1d'] ?? 0) ?></strong>
                </div>
                <div class="kpi">
                    <span class="label">2A</span>
                    <strong><?= tec_f($evaluacion['puntuacion_2a'] ?? 0) ?></strong>
                </div>
                <div class="kpi">
                    <span class="label">2B</span>
                    <strong><?= tec_f($evaluacion['puntuacion_2b'] ?? 0) ?></strong>
                </div>
                <div class="kpi">
                    <span class="label">3A</span>
                    <strong><?= tec_f($evaluacion['puntuacion_3a'] ?? 0) ?></strong>
                </div>
            </div>
        </section>
