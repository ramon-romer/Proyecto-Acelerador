CREATE DATABASE IF NOT EXISTS evaluador_aneca_salud CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS evaluaciones (
    ...
    area VARCHAR(100) NOT NULL DEFAULT 'Ciencias de la Salud',
