...
function salud_nf(mixed $value): string
{
...
<section class="card stack">
    <div class="resumen-top">
        ...
        <div class="box-mini">
            ...
            <span class="value"><?= salud_h((string)count($evaluaciones)) ?></span>
        </div>
        <div class="box-mini">
...
<section class="card stack">
    ...
    <p class="muted-small" style="margin:0;">
        Vista rápida de bloques, reglas y decisión final. El detalle completo se consulta dentro de cada evaluación.
    </p>
