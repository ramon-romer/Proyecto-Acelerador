...
function exp_nf(mixed $value): string
{
...
<section class="card stack">
    <div class="resumen-top">
        ...
        <div class="box-mini">
            ...
            <span class="value"><?= exp_h((string)count($evaluaciones)) ?></span>
        </div>
        <div class="box-mini">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <?php foreach ($evaluaciones as $fila): ?>
                        <tr>
                            <td data-label="ID"><?= exp_h((string)$fila['id']) ?></td>
                            <td data-label="Candidato" class="nombre"><?= exp_h((string)$fila['nombre_candidato']) ?></td>
                            <td data-label="Área"><?= exp_h((string)$fila['area']) ?></td>
                            <td data-label="Categoría"><?= exp_h((string)$fila['categoria']) ?></td>

                            <td data-label="B1" class="num"><?= exp_h(exp_nf($fila['bloque_1'] ?? 0)) ?></td>
                            <td data-label="B2" class="num"><?= exp_h(exp_nf($fila['bloque_2'] ?? 0)) ?></td>
                            <td data-label="B3" class="num"><?= exp_h(exp_nf($fila['bloque_3'] ?? 0)) ?></td>
                            <td data-label="B4" class="num"><?= exp_h(exp_nf($fila['bloque_4'] ?? 0)) ?></td>
                            <td data-label="1+2" class="num"><?= exp_h(exp_nf($fila['total_b1_b2'] ?? 0)) ?></td>
                            <td data-label="Total" class="num"><strong><?= exp_h(exp_nf($fila['total_final'] ?? 0)) ?></strong></td>
                            ...
                            <td data-label="Resultado"><?= exp_render_result_badge((string)$fila['resultado']) ?></td>
                            <td data-label="Fecha"><?= exp_h((string)$fila['fecha_creacion']) ?></td>
                            <td data-label="">
