    CREATE DATABASE IF NOT EXISTS evaluador_aneca_experimentales CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
    ...
    CREATE TABLE IF NOT EXISTS evaluaciones (
        ...
        area VARCHAR(100) NOT NULL DEFAULT 'Experimentales',
        comite VARCHAR(20) NOT NULL DEFAULT 'I',
