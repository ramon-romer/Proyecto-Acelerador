...
exp_render_layout_start(
    ...
    [
        ['label' => 'Volver al portal', 'url' => exp_portal_url(), 'class' => 'light'],
        ['label' => 'Ver evaluaciones', 'url' => exp_listado_url(), 'class' => 'light'],
    ]
);
?>
<div class="split">
    ...
    <aside class="stack">
        ...
        <section class="card">
            ...
            <div class="toolbar">
                <a class="btn outline" href="<?= exp_h(exp_portal_url()) ?>">Portal principal</a>
                <a class="btn outline" href="<?= exp_h(exp_listado_url()) ?>">Histórico de evaluaciones</a>
            </div>
        </section>
    </aside>
</div>
