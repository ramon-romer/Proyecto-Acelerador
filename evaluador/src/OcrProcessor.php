...
class OcrProcessor
{
    ...
    public function __construct()
    {
        ...
        $this->maxOcrPages = $this->readEnvInt('OCR_MAX_PAGES', 40, 1, 500);
        $this->ocrDpi = $this->readEnvInt('OCR_DPI', 180, 72, 300);
    }
    ...
    public function extraerTextoDesdePdf(string $pdfPath): string
    {
        ...
        try {
            ...
            foreach ($images as $img) {
                ...
                $textoPagina = $this->ocrImagen($img);
                if (trim($textoPagina) !== '') {
