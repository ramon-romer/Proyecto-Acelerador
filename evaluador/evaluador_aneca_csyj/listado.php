            ...
            <tbody>
                ...
                <?php else: ?>
                    <?php foreach ($evaluaciones as $fila): ?>
                        <tr>
                            <td data-label="ID"><?= csyj_h((string)$fila['id']) ?></td>
                            <td data-label="Candidato" class="nombre"><?= csyj_h((string)$fila['nombre_candidato']) ?></td>
                            <td data-label="Área"><?= csyj_h((string)$fila['area']) ?></td>
                            <td data-label="Categoría"><?= csyj_h((string)$fila['categoria']) ?></td>

                            <td data-label="B1" class="num"><?= csyj_h(csyj_nf($fila['bloque_1'] ?? 0)) ?></td>
                            <td data-label="B2" class="num"><?= csyj_h(csyj_nf($fila['bloque_2'] ?? 0)) ?></td>
                            <td data-label="B3" class="num"><?= csyj_h(csyj_nf($fila['bloque_3'] ?? 0)) ?></td>
                            <td data-label="B4" class="num"><?= csyj_h(csyj_nf($fila['bloque_4'] ?? 0)) ?></td>
                            <td data-label="1+2" class="num"><?= csyj_h(csyj_nf($fila['total_b1_b2'] ?? 0)) ?></td>
                            <td data-label="Total" class="num"><strong><?= csyj_h(csyj_nf($fila['total_final'] ?? 0)) ?></strong></td>
                            ...
                            <td data-label="Resultado"><?= csyj_render_result_badge((string)$fila['resultado']) ?></td>
                            <td data-label="Fecha"><?= csyj_h((string)$fila['fecha_creacion']) ?></td>
                            <td data-label="">
