...
$bloques = [
    [
        ...
        'items' => [
            ...
            '1.F Congresos y reuniones' => $evaluacion['puntuacion_1f'] ?? 0,
    ...
    [
        ...
        'items' => [
            ...
            '2.C Formación en docencia' => $evaluacion['puntuacion_2c'] ?? 0,
            '2.D Material docente / innovación' => $evaluacion['puntuacion_2d'] ?? 0,
        ],
...
<section class="stack">
    <section class="card">
        <div class="split" style="align-items:center;">
            <div class="stack" style="gap:10px;">
                <h2 style="margin:0;">Evaluación de <?= h($evaluacion['nombre_candidato'] ?? '') ?></h2>
                <p class="muted" style="margin:0;">
                    Área: <strong>Salud</strong> · Categoría: <strong><?= h($evaluacion['categoria'] ?? 'PCD/PUP') ?></strong>
                </p>
            </div>
    ...
    <section class="card">
        <details>
            ...
            <pre class="json-box"><?= h((string)$jsonBonito) ?></pre>
        </details>
    </section>
</section>
