...
<script>
        ...
        c.insertAdjacentHTML('beforeend', `
            <div class="fila">
                ...
                ${crearCampo('Subtipo índice', `
                    <input type="text" name="publicaciones[${i}][subtipo_indice]" placeholder="Ej. A / B / ICDS">`)}
                ${crearCampo('Afinidad', `
                ...
                ${crearCampo('Misma revista repetida', `
                    <select name="publicaciones[${i}][misma_revista_reiterada]">
            ...
            <div class="fila">
                ...
                ${crearCampo('Nivel editorial', `
                    <select name="libros[${i}][nivel_editorial]">
                        <option value="spi_alto">SPI alto</option>
                        <option value="spi_medio">SPI medio</option>
                ...
                ${crearCampo('Colección relevante', `
                    <select name="libros[${i}][coleccion_relevante]">
                        <option value="0">No</option>
                        <option value="1">Sí</option>
                    </select>`)}
            ...
            <div class="fila">
                ${crearCampo('Tipo', `
                    <select name="transferencia[${i}][tipo]">
                        ...
                        <option value="contrato_transferencia">Contrato/resultado transferible</option>
                        <option value="impacto_social">Impacto social</option>
                        <option value="difusion_especializada">Difusión especializada</option>
                    </select>`)}
                ${crearCampo('Impacto', `
    ...
    function agregarTesis() {
        ...
        c.insertAdjacentHTML('beforeend', `
            <div class="fila">
                ...
                ${crearCampo('Mención internacional', `
                    <select name="tesis_dirigidas[${i}][mencion_internacional]">
                        <option value="0">No</option>
                        <option value="1">Sí</option>
                    </select>`)}
            ...
            <div class="fila">
                ${crearCampo('Tipo aportación', `
                    <select name="congresos[${i}][tipo]">
                        ...
                        <option value="seminario">Seminario/Jornada</option>
                    </select>`)}
                ${crearCampo('Ámbito', `
                ...
                ${crearCampo('Nº participaciones mismo congreso', `
            ...
            <div class="fila">
                ${crearCampo('Tipo', `
                    <select name="otros_meritos_investigacion[${i}][tipo]">
                        ...
                        <option value="tribunal_tesis">Tribunal de tesis</option>
                        <option value="resena">Recensión / reseña</option>
                        <option value="divulgacion">Publicación divulgativa</option>
                        <option value="publicacion_tesis">Publicación tesis doctoral</option>
                        <option value="consejo_redaccion">Consejo de redacción</option>
                        <option value="revisor_revista">Revisor de revista</option>
                        <option value="premio_investigacion">Premio de investigación</option>
                        <option value="organizacion_investigacion">Organización de actividades</option>
                        <option value="coordinacion_libro">Coordinación/edición de libro</option>
    ...
    function agregarEvaluacionDocente() {
        ...
        c.insertAdjacentHTML('beforeend', `
            <div class="fila">
                ${crearCampo('Sistema', `
                    <select name="evaluacion_docente[${i}][sistema]">
            ...
            <div class="fila">
                ${crearCampo('Tipo', `
                    <select name="formacion_docente[${i}][tipo]">
                        <option value="seminario_docente">Seminario docente</option>
                        <option value="curso_docente">Curso docente</option>
                        <option value="recibir_formacion_docente">Recibir formación docente</option>
                    </select>`)}
                ${crearCampo('Orientado a docencia', `
                    <select name="formacion_docente[${i}][orientado_docencia]">
                        <option value="1">Sí</option>
                        <option value="0">No</option>
                    </select>`)}
                ${crearCampo('Ámbito', `
            ...
            <div class="fila">
                ${crearCampo('Tipo', `
                    <select name="material_docente[${i}][tipo]">
                        ...
                        <option value="material_publicado">Material docente publicado</option>
                        <option value="otro_docente">Otro mérito docente</option>
                    </select>`)}
                ...
                ${crearCampo('No son apuntes/guías', `
                    <select name="material_docente[${i}][no_apuntes_guias]">
                        <option value="1">Sí</option>
                        <option value="0">No</option>
                    </select>`)}
            ...
            <div class="fila">
                ${crearCampo('Tipo', `
                    <select name="formacion[${i}][tipo]">
                        <option value="doctorado_internacional">Doctorado con mención internacional</option>
                        <option value="beca_competitiva">Beca FPI/FPU o competitiva</option>
                        <option value="ayuda">Ayuda</option>
                        <option value="master">Máster</option>
                        <option value="curso_especializacion">Curso de especialización</option>
                        <option value="movilidad">Movilidad / estancia</option>
                    </select>`)}
                ${crearCampo('Duración', `
                    <input type="number" step="0.1" name="formacion[${i}][duracion]" min="0" value="1">`)}
                ${crearCampo('Tras terminar grado', `
                    <select name="formacion[${i}][posterior_grado]">
                        <option value="1">Sí</option>
                        <option value="0">No</option>
                    </select>`)}
    ...
    function agregarExperiencia() {
        ...
        c.insertAdjacentHTML('beforeend', `
            <div class="fila">
                ...
                ${crearCampo('Relación con ámbito', `
                    <select name="experiencia[${i}][relacion]">
                        <option value="alta">Alta</option>
                        <option value="media">Media</option>
                        <option value="baja">Baja</option>
                    </select>`)}
                ${crearCampo('Documentada', `
                    <select name="experiencia[${i}][documentada]">
                        <option value="1">Sí</option>
                        <option value="0">No</option>
                    </select>`)}
            ...
            <div class="fila">
                ${crearCampo('Tipo', `
                    <select name="bloque4[${i}][tipo]">
                        ...
                        <option value="cargo_unipersonal">Cargo unipersonal</option>
                        <option value="docencia_no_reglada">Docencia no reglada</option>
                        <option value="tfg_tfm">TFG/TFM / PFC</option>
                        <option value="tutor_uned">Tutor UNED</option>
                        <option value="curso_extension">Curso extensión / verano / cero</option>
                        <option value="otro">Otro mérito</option>
                    </select>`)}
                ${crearCampo('Relevancia', `
    ...
    <div class="stack">
        <section class="card">
            ...
            <div class="meta-grid">
                ...
                <div class="metric"><span class="label">Área</span><span class="value" style="font-size:20px">CSYJ</span></div>
        ...
        <section class="card stack">
            ...
            <form action="guardar_complemento.php" method="post" class="stack">
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Artículos indexados y publicaciones de investigación válidas.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Editoriales de prestigio; sin autoedición ni actas aquí.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Proyectos competitivos o de universidad debidamente certificados.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Transferencia de conocimiento o impacto relacionado.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Dirección o codirección de tesis.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            <h3>1.F Congresos, seminarios y jornadas</h3>
                            <p class="hint">Mejor internacional; se valora tipo de aportación.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Grupos, reseñas, premios, tribunales, revisiones, edición, etc.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Horas justificadas, grado o máster, responsabilidad.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">DOCENTIA o encuestas de evaluación.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            <h3>2.C Seminarios y cursos orientados a la docencia</h3>
                            <p class="hint">Solo si son de docencia, no de especialización científica.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            <h3>2.D Material docente y proyectos de innovación</h3>
                            <p class="hint">Publicado o con ISBN/ISSN. No apuntes ni guías.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Doctorado internacional, becas, ayudas, máster, cursos, movilidad.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Solo experiencia vinculada al ámbito y documentada.</p>
                        </div>
                ...
                <section class="bloque">
                    <div class="section-toolbar">
                        <div>
                            ...
                            <p class="hint">Gestión, docencia no reglada, TFG/TFM, UNED, extensión, etc.</p>
                        </div>
                ...
                <div class="form-actions">
                    ...
                    <a class="btn outline" href="<?= h(csyj_index_url()) ?>">Cancelar</a>
                    <a class="btn outline" href="<?= h(csyj_portal_url()) ?>">Ir al portal</a>
                </div>
            </form>
        </section>
    </div>
