...
/**
 * Validador tecnico de la salida legacy/transitoria del pipeline de meritos/scraping.
 *
 * Importante:
 * - No valida el contrato canonico oficial ANECA del proyecto.
 * - Se usa para robustez operativa local hasta completar la normalizacion total a ANECA.
 */
