...
if (!function_exists('acelerador_frontend_db_config')) {
    ...
    function acelerador_frontend_db_config()
    {
        ...
        return [
            'host' => acelerador_frontend_read_env(['ACELERADOR_DB_HOST', 'DB_HOST'], 'base-de-datos'),
            'user' => acelerador_frontend_read_env(['ACELERADOR_DB_USER', 'DB_USER'], 'usuario_web'),
            'pass' => acelerador_frontend_read_env(['ACELERADOR_DB_PASS', 'DB_PASS'], 'password_segura'),
