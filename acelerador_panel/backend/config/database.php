...
return [
    'host' => $readEnv(['DB_HOST', 'ACELERADOR_DB_HOST'], 'base-de-datos'),
    'user' => $readEnv(['DB_USER', 'ACELERADOR_DB_USER'], 'usuario_web'),
    'password' => $readEnv(['DB_PASS', 'ACELERADOR_DB_PASS'], 'password_segura'),
