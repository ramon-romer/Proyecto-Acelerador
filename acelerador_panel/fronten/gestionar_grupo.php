...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="https://uf3ceu.es/wp-content/uploads/logo-uf3-2k25.svg">s
...
<body>
  ...
  <main>
    <div class="formulario-tabla">
      ...
      <!-- Mensaje de feedback -->
      <?php if ($mensaje): ?>
        <div class="alert alert-<?php echo $tipo_mensaje; ?> alert-dismissible fade show w-100 rounded-3" role="alert"
        ...
        <form method="POST" style="padding: 0; margin: 0;">
          ...
          <div class="mb-2" style="display: flex; flex-direction: column; width: 100%; gap: 0; margin: 0;">
            <label class="form-label text-light small mb-1 w-100 text-start" style="font-size: 0.85rem;">ORCID del
              profesor</label>
            <input type="text" name="orcid" class="form-control input-orcid w-100" placeholder="0000-0000-0000-0000"
