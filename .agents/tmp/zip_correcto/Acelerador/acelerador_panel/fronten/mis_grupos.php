...
<body>
  ...
  <main>
    <div class="formulario text-center" style="max-width: 800px; width: 90%; margin: 50px auto;">
      ...
      <div class="mb-4">
        <i class="bi bi-diagram-3 text-white mb-2" style="font-size: 3.5rem; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.3));"></i>
      ...
      <?php if (count($mis_grupos) > 0): ?>
        <div class="table-responsive w-100 mb-4 p-3 p-md-4" style="border-radius: 15px; background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.15);">
          <table class="table tabla-glass mb-0 text-start">
            <thead>
              <tr>
                <th scope="col" class="border-top-0 border-end-0 border-bottom text-white px-4 py-3"><i class="bi bi-tag-fill me-1"></i> Nombre del Grupo</th>
                <th scope="col" class="border-top-0 border-end-0 border-bottom text-white py-3"><i class="bi bi-person-badge-fill me-1"></i> Tutor Asignado</th>
                <th scope="col" class="border-top-0 border-end-0 border-bottom text-white px-4 py-3"><i class="bi bi-envelope-fill me-1"></i> Contacto</th>
              </tr>
            </thead>
            <tbody>
              <?php foreach ($mis_grupos as $grupo): ?>
                <tr>
                  <td class="border-end-0 fw-bold border-bottom-0 text-white px-4 py-3"><?php echo htmlspecialchars($grupo['grupo_nombre']); ?></td>
                  <td class="border-end-0 border-bottom-0 text-white py-3"><?php echo htmlspecialchars($grupo['tutor_nombre'] . ' ' . $grupo['tutor_apellidos']); ?></td>
                  <td class="border-end-0 border-bottom-0 text-white-50 px-4 py-3">
                    <a href="mailto:<?php echo htmlspecialchars($grupo['tutor_correo']); ?>" class="text-white text-decoration-none">
      ...
      <?php else: ?>
        <div class="w-100 text-center p-5 rounded-4 mb-4" style="background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.15);">
      ...
      <div class="d-flex justify-content-center w-100 mt-2 mb-5">
        <a href="panel_profesor.php" class="btn btn-volver px-4 py-2 rounded-pill fw-medium d-inline-flex align-items-center gap-2 shadow-sm transition-all text-decoration-none">
