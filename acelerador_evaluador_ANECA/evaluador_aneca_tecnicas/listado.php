...
<section class="card stack">
    <div class="meta-grid">
        ...
        <div class="metric"><span class="label">Registros</span><span class="value"><?= tec_h((string)count($evaluaciones)) ?></span></div>
    </div>
        ...
        <table>
            ...
            <?php foreach ($evaluaciones as $fila): ?>
                <tr>
                    ...
                    <td><?= tec_h($fila['nombre_candidato']) ?></td>
                    <td><?= tec_h($fila['area']) ?></td>
                    <td><?= tec_h($fila['categoria']) ?></td>
                    <td><?= tec_h((string)$fila['total_final']) ?></td>
                    <td><?= tec_render_result_badge((string)$fila['resultado']) ?></td>
                    <td><?= tec_h($fila['fecha_creacion']) ?></td>
