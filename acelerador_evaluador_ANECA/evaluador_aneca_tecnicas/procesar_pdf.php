...
<section class="card stack">
    ...
    <div class="stats-grid">
        <div class="metric"><span class="label">1A Publicaciones</span><span class="value"><?= tec_h((string)(count($jsonExtraido['bloque_1']['publicaciones'] ?? []))) ?></span></div>
        <div class="metric"><span class="label">1B Libros</span><span class="value"><?= tec_h((string)(count($jsonExtraido['bloque_1']['libros'] ?? []))) ?></span></div>
...
<section class="card stack">
    ...
    <div class="toolbar">
        <form action="guardar_evaluacion.php" method="post">
            <input type="hidden" name="nombre_candidato" value="<?= tec_h($nombre_candidato) ?>">
