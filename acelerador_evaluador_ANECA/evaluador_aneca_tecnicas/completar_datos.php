            ...
            c.insertAdjacentHTML('beforeend', `
                <div class="fila">
                    ...
                    ${crearCampo('Subtipo índice', `
                        <input type="text" name="publicaciones[${i}][subtipo_indice]" placeholder="Ej. A, B1...">`)}
                ...
                <div class="fila">
                    ${crearCampo('Tipo', `
                        <select name="transferencia[${i}][tipo]">
                            ...
                            <option value="software_explotacion">Software explotación</option>
                            <option value="prototipo_transferido">Prototipo transferido</option>
                            <option value="spin_off">Spin-off</option>
                            <option value="contrato_empresa">Contrato empresa</option>
                        </select>`)}
            ...
            c.insertAdjacentHTML('beforeend', `
                <div class="fila">
                    ...
                    ${crearCampo('ID evento', `
                        <input type="text" name="congresos[${i}][id_evento]" placeholder="tec_conf_1">`)}
                ...
                <div class="fila">
                    ${crearCampo('Tipo', `
                        <select name="material_docente[${i}][tipo]">
                            ...
                            <option value="software_docente">Software docente</option>
                            <option value="laboratorio_virtual">Laboratorio virtual</option>
                        </select>`)}
                ...
                <div class="fila">
                    ${crearCampo('Tipo', `
                        <select name="formacion[${i}][tipo]">
                            ...
                            <option value="acreditacion_profesional">Acreditación profesional</option>
                        </select>`)}
...
<section class="card stack">
    <div class="meta-grid">
        <div class="metric"><span class="label">Candidato</span><span class="value" style="font-size:20px"><?= tec_h($nombre) ?></span></div>
...
<form action="guardar_complemento.php" method="post">
        ...
        <div class="bloque">
            <h3>1.A Publicaciones, patentes y software</h3>
            <div id="publicaciones"></div>
            <p class="hint">Usa este bloque para completar Publicaciones, Patentes y software al procesar.</p>
            <button type="button" class="btn" onclick="agregarPublicacion()">Añadir publicación</button>
        </div>

        <div class="bloque">
            <h3>1.B Libros y capítulos</h3>
            <p class="hint">Usa este bloque para completar Libros y Capitulos al procesar.</p>    
            <div id="libros"></div>
        ...
        <div class="bloque">
            <h3>1.C Proyectos</h3>
            <p class="hint">Usa este bloque para completar Proyectos al procesar.</p>    
        ...
        <div class="bloque">
            ...
            <p class="hint">Usa este bloque para completar Transferencia al procesar.</p>    
        ...
        <div class="bloque">
            ...
            <p class="hint">Usa este bloque para completar Otros méritos de Investigación al procesar.</p>    
        ...
        <div class="bloque">
            ...
            <p class="hint">Usa este bloque para completar Evaluación Docente al procesar.</p>    
        ...
        <div class="bloque">
            ...
            <p class="hint">Usa este bloque para completar Otros Méritos al procesar.</p>    
            <div id="bloque4"></div>
    ...
    <aside class="stack">
        <section class="card">
            ...
            <div class="kpis">
                    <div class="kpi"><span class="label">1A Publicaciones</span><strong><?= tec_h((string)$resumen['1A Publicaciones']) ?></strong></div>
                    <div class="kpi"><span class="label">1B Libros</span><strong><?= tec_h((string)$resumen['1B Libros']) ?></strong></div>
                    <div class="kpi"><span class="label">1C Proyectos</span><strong><?= tec_h((string)$resumen['1C Proyectos']) ?></strong></div>
                    <div class="kpi"><span class="label">1D Transferencia</span><strong><?= tec_h((string)$resumen['1D Transferencia']) ?></strong></div>
                    <div class="kpi"><span class="label">2A Docencia</span><strong><?= tec_h((string)$resumen['2A Docencia']) ?></strong></div>
                    <div class="kpi"><span class="label">3A Formación</span><strong><?= tec_h((string)$resumen['3A Formación']) ?></strong></div>
                    <div class="kpi"><span class="label">4 Otros méritos</span><strong><?= tec_h((string)$resumen['4 Otros méritos']) ?></strong></div>
            </div>
        </section>
