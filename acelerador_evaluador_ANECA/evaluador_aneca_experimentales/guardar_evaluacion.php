...
|--------------------------------------------------------------------------
| Ajusta estos valores a la rúbrica real de Experimentales si fuera necesario.
*/
$maximos = [
    '1A' => 35,
    '1B' => 7,
...
$sql = "INSERT INTO evaluaciones (
    nombre_candidato, area, comite, categoria, json_entrada,
...
<div class="contenedor">
    ...
    <p><strong>Comité:</strong> <?= htmlspecialchars($comite) ?></p>
    <p>
