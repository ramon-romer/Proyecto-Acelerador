...
$sql = "SELECT id, nombre_candidato, area, comite, categoria, total_final, resultado, fecha_creacion
        FROM evaluaciones
        ORDER BY id DESC";
...
<div class="contenedor">
    <h1>Listado de evaluaciones - Experimentales</h1>
    ...
    <table>
        ...
        <?php foreach ($evaluaciones as $fila): ?>
            <tr>
                ...
                <td><?= htmlspecialchars($fila['comite']) ?></td>
