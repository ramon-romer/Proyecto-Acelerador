...
$jsonExtraido['area'] = 'Experimentales';
...
<section class="card stack">
    <div class="meta-grid">
        <div class="metric">
            ...
            <span class="value" style="font-size:20px"><?= exp_h($nombreCandidato) ?></span>
        </div>
        <div class="metric">
            <span class="label">Archivo</span>
            <span class="value" style="font-size:18px"><?= exp_h(basename($rutaPdf)) ?></span>
        </div>
        <div class="metric">
        ...
        <div class="metric">
            ...
            <span class="value" style="font-size:20px"><?= exp_h($etiquetaFormato) ?></span>
        </div>
    </div>
</section>
    ...
    <div class="resumen-grid">
        <?php foreach ($resumen as $label => $valor): ?>
            <div class="resumen-item">
                <span class="k"><?= exp_h($label) ?></span>
                <span class="v"><?= exp_h((string)$valor) ?></span>
            </div>
        <?php endforeach; ?>
    </div>

    <div class="subinfo">
        Referencia de máximos en Experimentales: B1=60, B2=30, B3=8, B4=2.
...
<section class="card stack">
    ...
    <div class="toolbar">
        <form action="guardar_evaluacion.php" method="post">
            <input type="hidden" name="nombre_candidato" value="<?= exp_h($nombreCandidato) ?>">
